...
exports.addDomain = async (req, res, next) => {
  try {
    ...
    audit.log(req, 'domain.create', 'domain', domain._id, { name: domain.name, registrar: domain.registrar });
...
exports.updateDomain = async (req, res, next) => {
  try {
    ...
    audit.log(req, 'domain.update', 'domain', domain._id, { name: domain.name });
...
exports.addDNSRecord = async (req, res, next) => {
  try {
    ...
    await domain.save();
    audit.log(req, 'domain.dns-record-add', 'domain', domain._id, { type: req.body.type, name: req.body.name });
