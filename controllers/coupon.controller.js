...
//     try {
//         const{
//             code, description, discountType, discountValue, maxUses, minOrderAmount, applicablePlans, expiresAt,
//         } = req.body;
...
//         audit.log(req, 'coupon.create', 'coupon', coupon._id, { code: coupon.code });
...
//         if (!coupon) return error(res, 'Coupon not found', 404);
//         audit.log(req, 'coupon.update', 'coupon', coupon._id, { code: coupon.code });
...
//         if (!coupon) return error(res, 'Coupon not found', 404);
//         audit.log(req, 'coupon.delete', 'coupon', coupon._id, { code: coupon.code });
...
//         const discountAmount = coupon.calcDiscount(orderAmount);
//         return success(res, {
//             coupon: {
//                 _id: coupon._id,
//                 code: coupon.code,
...
//             r => r.tenantId?.toString() === newTenantId
//         );
...
//         if (!entry) return error(res, 'Referred tenant not found in this referral', 404);
