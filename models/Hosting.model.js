...
const HostingSchema = new mongoose.Schema({
  ...
  emailHosting: {
    enabled: { type: Boolean, default: false },
    provider: { type: String },       // e.g. Google Workspace, Zoho, cPanel Mail
    accounts: { type: Number, default: 0 },  // number of email accounts
    storageGB: { type: Number },      // storage per account
    expiryDate: { type: Date },
    renewalCost: { type: Number },
    notes: { type: String },
  },
